...
app.get("/:type", (req, res) => {
  var results = jokes.filter(function (entry) {
    return entry.jokeType.toLowerCase() === req.query.type
  })
  res.json(results)
});
...
app.put("/jokes/:id", (req, res) =>{
  ...
  jokes[req.params.id - 1] = newData;
  console.log("Broma sustituida con exito: \n" + JSON.stringify(jokes[req.params.id - 1]))
  res.json(jokes[req.params.id - 1])
});
//5. PUT a joke
...
app.patch("/jokes/:id", (req, res) =>{
  if(req.body.jokeText){
    jokes[req.params.id - 1].jokeText = req.body.jokeText;
  }
  if(req.body.jokeType){
    jokes[req.params.id - 1].jokeType = req.body.jokeType;
  }
  console.log("Propiedades de la broma modificadas con exito: \n" + JSON.stringify(jokes[req.params.id - 1]))
  res.json(jokes[req.params.id - 1])
});
//6. PATCH a joke
...
app.delete("/all", (req, res) =>{
    jokes = [];
    res.json(jokes + "listo pues parce pues")
});
//8. DELETE All jokes
